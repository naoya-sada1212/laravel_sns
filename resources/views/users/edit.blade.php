          ...
          <form method="POST" action="{{ url('users/'.$user->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group row align-items-center">
              ...
              <div class="col-md-6 d-flex align-items-center">
                ...
                <input type="file" name="profile_image" class="@error('profile_image') is_invalid @enderror" autocomplete="profile_image">
            ...
            <div class="form group row">
              <label for="screen_name" class="col-md-4 col-form-label text-md-right">{{ __('Accunt Name') }}</label>
              
              <div class="col-md-6">
                <input id="screen_name" type="text" class="form-control @error('screen_name') is_invalid @enderror" name="screen_name" value="{{ $user->screen_name }}" required autocomplete="screen_name" autofocus>
