          ...
          <div class="card">
            <div class="card-header p-3 w-100 d-flex">
              ...
              <div class="ml-2 d-flex flex-column">
                ...
                <a href="{{ url('users/' .$timeline->user->id) }}" class="text-secndary">{{ $timeline->user->screen_name }}</a>
              </div>
            ...
            <div class="card-footer py-1 d-flex justify-content-end bg-white">
              ...
              <div class="d-flex align-items-center">
                @if (!in_array($user->id, array_column($timeline->favorite->toArray(), 'user_id'), TRUE))
                ...
                @else
                  <form method="POST" action="{{ url('favorites/' .array_column($timeline->favorite->toArray(), 'id', 'user_id')[$user->id]) }}" class="mb-0">
                    @csrf
                    @method('DELETE')
