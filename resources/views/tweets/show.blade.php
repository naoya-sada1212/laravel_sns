          ...
          <div class="card">
            <div class="card-header p-3 w-100 d-flex">
              ...
              <div class="ml-2 d-flex flex-column">
                ...
                <a href="{{ url('users/' .$tweet->user->id) }}" class="text-secndary">{{ $tweet->user->screen_name }}</a>
              </div>
          ...
          <li class="list-group-item">
            <div class="py-3 w-100 d-flex">
              ...
              <div class="ml-2 d-flex flex-column">
                ...
                <a href="{{ url('user/'.$comment->user->id) }}" class="text-secondary">{{ $comment->user->screen_name }}</a>
              </div>
              <div class="d-flex justify-content-end flex-grow-1">
